document.addEventListener('DOMContentLoaded', ()=>{
                ...
                window.addEventListener('mousemove', (e)=>{
                    document.getElementsByClassName('team-member-mask')[0].classList.remove('team-member-mask-start');
                    document.getElementsByClassName('masked-image')[0].classList.remove('masked-image-start');
                ...
                images.forEach(img=>{
                    ...
                    if (img.getAttribute('data-member-bg') == 'lerato')
                        return;
                ...
                radiobtn.forEach(e=>{
                    e.addEventListener('mouseover', ()=>{
                        ...
                        startRippleEffect(imageUrls[memberId]);
                        // This passes the URL string correctly
                ...
                function startRippleEffect(imgUrl) {
                    ...
                    document.querySelectorAll(".masked-image").forEach((item)=>{
                        item.innerHTML = '';
                        // Clear previous canvas to prevent WebGL crash
                ...
                // Fixed Loader Logic
                const textures = {};
                // Global store for loaded textures
                let material;
                // Global reference for your shader material
                ...
                if (typeof THREE === "undefined") {
                    ...
                    s.onload = ()=>preloadTextures(()=>startRippleEffect(imageUrls["Lerato"]));
                    document.body.appendChild(s);
                } else {
                    preloadTextures(()=>startRippleEffect(imageUrls["Lerato"]));
                }
            }
            )
